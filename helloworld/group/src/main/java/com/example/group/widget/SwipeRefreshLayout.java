...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                int targetTop = SwipeRefreshLayout.this.mFrom + (int) ((float) (endTarget - SwipeRefreshLayout.this.mFrom) * interpolatedTime);
    ...
    public interface OnChildScrollUpCallback {
        boolean canChildScrollUp(@NonNull SwipeRefreshLayout var1, @Nullable View var2);
    }
